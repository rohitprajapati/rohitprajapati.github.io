...
var play1 = {
    ...
    boardIn: function () {
        ...
        var r = play1_result ? 'YOU WON' : 'YOU LOSE';
        var resultText = game.make.text(0, -50, r, {fill: '#ffffff', font: 'bold 20pt Comic Sans MS'});
...
var play2 = {
    ...
    boardIn: function () {
        ...
        var r = play2_result ? 'YOU WON' : 'YOU LOSE';
        var resultText = game.make.text(0, -50, r, {fill: '#ffffff', font: 'bold 20pt Comic Sans MS'});
        resultText.anchor.set(0.5);
        boardSprite.addChild(resultText);
...
var play3 = {
    ...
    boardIn: function () {
        ...
        var r = play3_result ? 'YOU WON' : 'YOU LOSE';
        var resultText = game.make.text(0, -50, r, {fill: '#ffffff', font: 'bold 20pt Comic Sans MS'});
        resultText.anchor.set(0.5);
        boardSprite.addChild(resultText);
